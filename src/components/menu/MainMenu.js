...
const MainMenu = () => {
    ...
    return (
        ...
        <div className={`main-menu ${!mainMenu && "hidden"}`}>
            ...
            <div className="btns">
               <button className="btn btn-primary" onClick={toggleComputerMenu}>Play Against Computer</button>
               <button className="btn btn-secondary" onClick={togglePlayerMenu}>Play Against Opponent</button>
            </div>
        ...
        <ComputerMenu computerMenu={computerMenu} setComputerMenu={setComputerMenu}/>
        <PlayerMenu playerMenu={playerMenu} setPlayerMenu={setPlayerMenu} />
        </Fragment>
    )
}
